...
int main(void){
	...
	//wiringPiI2CWriteReg8(RTC, HOUR_REGISTER, decCompensation(HH));
	//wiringPiI2CWriteReg8(RTC, MIN_REGISTER, decCompensation(MM));
	//wiringPiI2CWriteReg8(RTC, SEC_REGISTER, decCompensation(SS));
